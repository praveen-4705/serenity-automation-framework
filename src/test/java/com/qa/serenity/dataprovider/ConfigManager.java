package com.qa.serenity.dataprovider;
	...
	private static final Logger LOGGER = LoggerFactory.getLogger("ConfigManager");
		...
		public String getProperty(String key) {
			...
			if (key != "") {
				...
				try {
					...
					LOGGER.error("Key - '" + key + "' does not exist or not given a value in " + configFileName+ ".properties file \n");
				}
			} else {
		...
		private void loadProperties() {
			...
			try {
				...
				LOGGER.error("Cannot find configuration file - " + configFileName + ".properties" + " at "
